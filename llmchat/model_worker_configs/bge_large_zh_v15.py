...
config = {
    ...
    "base": {
        "online_api": False,  # True:线上模型, False:离线模型
        "vllm_enabled": False,
    },

    "server": {
        "host": os.getenv("DEFAULT_MODEL_WORKER_HOST11", "127.0.0.1"),
        "port": int(os.getenv("DEFAULT_MODEL_WORKER_PORT11", 21013))
    },

    # 离线模型
    "offline_model": {
        "model_path": "E:/WorkSpace/LLMWorkSpace/Models/Embedding/bge-large-zh-v1.5",
